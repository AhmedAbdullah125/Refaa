...
import back from '../../assets/images/2.jpg'
import back2 from '../../assets/images/ss.webp'
import back3 from '../../assets/images/1.jpg'
...
export default function HomeSwiper() {
    ...
    return (
        <div className="container m-auto home-slider">
            <Swiper
                // navigation
            ...
            >
                ...
                <SwiperSlide >
                    <div className="slide-img">
                        <Image src={back2} alt='Loops' />
                    </div>
                </SwiperSlide>
                <SwiperSlide >
                    <div className="slide-img">
                        <Image src={back3} alt='Loops' />
                    </div>
                </SwiperSlide>
